export const dataFake = [
  {
    "id":"1",
    "title": "NEW 3D IRON MAN",
    "description": "Marvel announces a new Iron Man film, check it out",
  ...
  {
    "id":"2",
    "title": "New Series Announced on Disney+",
    "description": "New Series Announced on Disney+, check it out",
    "photoCover":"https://disneyplusbrasil.com.br/wp-content/uploads/2021/07/Series-Marvel-Disney-Plus-1024x576.jpg"
  },
  {
    "id":"3",
    "title": "New Black Panther movie coming soon",
    "description": "New Black Panther movie coming soon, check it out",
  ...
  {
    "id":"4",
    "title": "New X-Men film is in post-production",
    "description": "New X-Men film is in post-production, says director",
